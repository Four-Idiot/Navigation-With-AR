...
public class LocalMarkerRepository : IMarkerRepository
{
    ...
    public LocalMarkerRepository()
    {
        ...
        poiInfos = new()
        {
            ...
            new Marker(id++, MarkerType.DOSENT, "홍익돈까스", "파주운정점", new Coords(126.740820f,37.714277f), "경기 파주시 와석순환로172번길 3", 9, 20),
            new Marker(id++, MarkerType.HOSPITAL, "대한상공회의소 경기인력개발원", String.Empty, new Coords(126.743572f,37.713675f), "경기 파주시 와석순환로172번길 16", 9, 20),
        };
    }
